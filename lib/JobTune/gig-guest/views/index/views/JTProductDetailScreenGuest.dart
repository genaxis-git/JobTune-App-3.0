...
import '../../../../../../main.dart';
import 'JTAddressScreenGuest.dart';
import 'JTDrawerWidgetGuest.dart';
import 'JTReviewWidgetGuest.dart';

class JTProductDetailScreenGuest extends StatefulWidget {
  static String tag = '/JTProductDetailScreenGuest';
  DTProductModel? productModel;

  JTProductDetailScreenGuest({this.productModel});

  @override
  _JTProductDetailScreenGuestState createState() => _JTProductDetailScreenGuestState();
}

class _JTProductDetailScreenGuestState extends State<JTProductDetailScreenGuest> {
  var discount = 0.0;
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    var res = await JTAddressScreenGuest().launch(context);
    ...
    Widget webWidget() {
      return Column(
        ...
        children: [
          ...
          JTReviewWidgetGuest(list: getReviewList()),
        ],
      );
    }
