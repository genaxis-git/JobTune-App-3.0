...
class JTReviewWidgetGuest extends StatefulWidget {
  static String tag = '/JTReviewWidgetGuest';
  final List<DTReviewModel>? list;
  final bool? enableScrollPhysics;

  JTReviewWidgetGuest({this.list, this.enableScrollPhysics});

  @override
  _JTReviewWidgetGuestState createState() => _JTReviewWidgetGuestState();
}

class _JTReviewWidgetGuestState extends State<JTReviewWidgetGuest> {
  @override
  void initState() {
    super.initState();
    init();
