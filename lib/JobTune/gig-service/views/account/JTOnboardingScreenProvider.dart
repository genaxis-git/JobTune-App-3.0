...
import 'JTAccountScreenUser.dart';

class JTOnboardingScreenProvider extends StatefulWidget {
  static String tag = '/JTOnboardingScreenProvider';
  @override
  _JTOnboardingScreenProviderState createState() => _JTOnboardingScreenProviderState();
}

class _JTOnboardingScreenProviderState extends State<JTOnboardingScreenProvider> {
