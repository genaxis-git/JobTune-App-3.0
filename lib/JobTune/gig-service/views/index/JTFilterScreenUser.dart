...
class JTFilterScreenUser extends StatefulWidget {
  static String tag = '/JTFilterScreenUser';

  @override
  _JTFilterScreenUserState createState() => _JTFilterScreenUserState();
}

class _JTFilterScreenUserState extends State<JTFilterScreenUser> {
