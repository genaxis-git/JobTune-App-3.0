...
class JTScheduleScreenUser extends StatefulWidget {
  static String tag = '/JTScheduleScreenUser';

  @override
  _JTScheduleScreenUserState createState() => _JTScheduleScreenUserState();
}

class _JTScheduleScreenUserState extends State<JTScheduleScreenUser> {
