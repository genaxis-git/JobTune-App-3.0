...
class WebViewTimetableUser extends StatefulWidget {
  const WebViewTimetableUser({Key? key, required this.id}) : super(key: key);
  final String id;
  @override
  _WebViewTimetableUserState createState() => _WebViewTimetableUserState();
}

class _WebViewTimetableUserState extends State<WebViewTimetableUser> {
