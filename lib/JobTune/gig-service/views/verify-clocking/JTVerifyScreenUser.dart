...
import '../../../../main.dart';
import 'JTVerifyRecordScreen.dart';
                                  ...
                                  Row(
                                    children: [
                                      (clocking[index]["clock_in"] == "0000-00-00 00:00:00")
                                          ...
                                          ? (clocking[index]["in_status"] == "Verified")
                                          ? Icon(Icons.check_circle,size: textSizeSMedium,color: Colors.green,)
                                          : Icon(Icons.cancel,size: textSizeSMedium,color: Colors.redAccent,)
                                  ...
                                  Row(
                                    children: [
                                      (clocking[index]["clock_out"] == "0000-00-00 00:00:00")
                                          ...
                                          ? (clocking[index]["out_status"] == "Verified")
                                          ? Icon(Icons.check_circle,size: textSizeSMedium,color: Colors.green,)
                                          : Icon(Icons.cancel,size: textSizeSMedium,color: Colors.redAccent,)
                                          : Icon(Icons.check_circle_outline,size: textSizeSMedium,color: Colors.orangeAccent,),
                      ...
                      IconButton(
                          onPressed: (){
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => JTVerifyRecordScreen(
