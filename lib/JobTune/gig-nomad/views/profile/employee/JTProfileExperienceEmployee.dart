...
class JTProfileExperienceEmployee extends StatefulWidget {
  static const tag = '/JTProfileExperienceEmployee';

  @override
  _JTProfileExperienceEmployeeState createState() => _JTProfileExperienceEmployeeState();
}

class _JTProfileExperienceEmployeeState extends State<JTProfileExperienceEmployee> {
  int currStep = 3;
