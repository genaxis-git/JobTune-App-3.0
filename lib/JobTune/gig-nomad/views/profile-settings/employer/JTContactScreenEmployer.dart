...
class JTContactScreenEmployer extends StatefulWidget {
  @override
  _JTContactScreenEmployerState createState() => _JTContactScreenEmployerState();
}

class _JTContactScreenEmployerState extends State<JTContactScreenEmployer> {
