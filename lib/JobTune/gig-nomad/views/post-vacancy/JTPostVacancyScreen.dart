...
import 'JTPostVacancyForm.dart';

class JTPostVacancyScreen extends StatefulWidget {
  static String tag = '/JTAccountScreenUsers';

  @override
  _JTPostVacancyScreenState createState() => _JTPostVacancyScreenState();
}

class _JTPostVacancyScreenState extends State<JTPostVacancyScreen> {
