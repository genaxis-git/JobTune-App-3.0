...
class JTPostVacancyForm extends StatefulWidget {
  @override
  _JTPostVacancyFormState createState() => _JTPostVacancyFormState();
}

class _JTPostVacancyFormState extends State<JTPostVacancyForm> {
