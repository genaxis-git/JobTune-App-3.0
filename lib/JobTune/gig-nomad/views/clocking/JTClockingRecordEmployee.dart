...
class JTClockingRecordEmployee extends StatefulWidget {
  const JTClockingRecordEmployee({
    Key? key,
  ...
  final String jobid;
  @override
  _JTClockingRecordEmployeeState createState() => _JTClockingRecordEmployeeState();
}

class _JTClockingRecordEmployeeState extends State<JTClockingRecordEmployee> {
