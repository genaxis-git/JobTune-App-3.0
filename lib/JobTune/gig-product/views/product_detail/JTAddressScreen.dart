...
class JTAddressScreen extends StatefulWidget {
  static String tag = '/JTAddressScreen';

  @override
  _JTAddressScreenState createState() => _JTAddressScreenState();
}

class _JTAddressScreenState extends State<JTAddressScreen> {
